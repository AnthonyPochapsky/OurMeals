...
Partial Class ConfirmListItemDeletionForm
    ...
    Private Sub InitializeComponent()
        ...
        NameOfItem.Location = New Point(16, 39)
        ...
        AreYouSureLabel.Size = New Size(301, 15)
        AreYouSureLabel.TabIndex = 12
        AreYouSureLabel.Text = "Are you sure that you want to delete the following item:" & vbCrLf
        ' 
        ' NoButton
        ' 
        ...
        Name = "ConfirmListItemDeletionForm"
        StartPosition = FormStartPosition.CenterParent
        Text = "Confirm Item Deletion"
        ResumeLayout(False)
        PerformLayout()
    End Sub
